                        ...
                        if jm:
                            ...
                            if urgency in ("critical", "high"):
                                try:
                                    ...
                                    # Deep-link to open the original email in Aegis (if public URL is configured).
                                    ...
                                    # HTML alternative with a clickable "Open in Aegis" button
                                    import html as _h
