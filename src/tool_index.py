...
BUILTIN_TOOL_DESCRIPTIONS: Dict[str, str] = {
    ...
    "edit_document": "Preferred tool for editing an existing document — targeted find-and-replace. Use for small changes. Imported Word files only accept layout-safe edits within one existing text run; PDF text edits become a separate text copy, while PDF forms and annotations can be exported on the original PDF.",
